...
public sealed class PixelPointPoly : Polygon<PixelPoint>, IPolygon<PixelPointPoly>
{
	...
	private PixelPointPoly(Func<Wgs1984, int, PixelPoint> pointConverter, int zoomLevel, IEnumerable<Line2> edges)
		: base(edges)
	{
		PointConverter = pointConverter;
		ZoomLevel = zoomLevel;
	...
	public PixelPointPoly CreateFromEdges(IEnumerable<Line2> edges) => new PixelPointPoly(PointConverter, ZoomLevel, edges);
